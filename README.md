...
Here, the user name is `test`. After you get the bridge generated username, you need to copy the string and save it in user variable, and comment the following part of code
